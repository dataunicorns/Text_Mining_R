...
peanutallergy_corpus <- read.csv("C:\\Users\\prathyusha\\Desktop\\peanutallergy.csv", header = T, sep=",")
...
crimson_data <- data.frame(crimson_text_corpus$Contents[1:8891],crimson_text_corpus$doc_id[1:8891], crimson_text_corpus$code[1:8891])
